...
class AirCargoProblem(Problem):
    ...
    def get_actions(self):
        ...
        def load_actions():
            ...
            for air_port in self.airports:
                for p in self.planes:
                    for c in self.cargos:
                        precond_pos = [expr("At({}, {})".format(c, air_port)),
                                       expr("At({}, {})".format(p, air_port)),
                                       ]
                        precond_neg = []
                        effect_add = [expr("In({}, {})".format(c, p))]
#                        effect_rem = [expr("At({}, {})".format(p, fr))]
                        effect_rem = [expr("At({}, {})".format(c, air_port))]
                        load = Action(expr("Load({}, {}, {})".format(c, p, air_port)),
            ...
            for air_port in self.airports:
                for p in self.planes:
                    for c in self.cargos:
                        ...
                        precond_neg = []
                        effect_add = [expr("At({}, {})".format(c, air_port))]
#                        effect_rem = [expr("At({}, {})".format(p, fr))]
                        effect_rem = [expr("In({}, {})".format(c, p))]
                        unload = Action(expr("Unload({}, {}, {})".format(c, p, air_port)),
                                     [precond_pos, precond_neg],
                                     [effect_add, effect_rem])
    ...
    def actions(self, state: str) -> list:
        ...
        possible_actions = []
        kb = PropKB()
        # print("In actions function -----> kb - ")
        # print(kb.clauses)
        kb.tell(decode_state(state, self.state_map).pos_sentence())
        # print("In actions function -----> kb after decode - ")
        # print(kb.clauses)
        for action in self.actions_list:
            ...
            if is_possible:
                ...
                # print("In actions function ----->  possible_actions.append(action) :")
                # print(action.name)
                # print(action.args)
                # print(action.precond_pos)
                # print(action.precond_neg)
                # print(action.effect_add)
                # print(action.effect_rem)
        return possible_actions
    ...
    def result(self, state: str, action: Action):
        ...
        for fluent in action.effect_rem:
            if fluent not in new_state.neg:
                new_state.neg.append(fluent)
        #print("In results function ----->  encode_state(new_state, self.state_map) - ")
    ...
    def h_ignore_preconditions(self, node: Node):
        ...
        # # print("count ")
        # # print(count)
        # self.action_list = possible_actions
        # return count
        ...
        while not goal.issubset(cover):
            ...
            if max_cover_action is None:
                ...
                action_count += 1
        #print("before return action_count - ")
        #print(action_count)
        return action_count
